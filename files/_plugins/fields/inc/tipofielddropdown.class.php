...
class PluginFieldsTipofieldDropdown extends CommonTreeDropdown {
   public $field_name      = "tipofield";
   ...
   static function install() {
      ...
      if (!$DB->tableExists($table)) {
         $query = "CREATE TABLE IF NOT EXISTS `$table` (
                  ...
                  `plugin_fields_tipofielddropdowns_id` INT(11)        DEFAULT NULL,
                  ...
                  KEY                                       `plugin_fields_tipofielddropdowns_id`
                                                            (`plugin_fields_tipofielddropdowns_id`)
