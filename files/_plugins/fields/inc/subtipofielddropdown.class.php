...
class PluginFieldsSubtipofieldDropdown extends CommonTreeDropdown {
   public $field_name      = "subtipofield";
   ...
   static function install() {
      ...
      if (!$DB->tableExists($table)) {
         $query = "CREATE TABLE IF NOT EXISTS `$table` (
                  ...
                  `plugin_fields_subtipofielddropdowns_id` INT(11)        DEFAULT NULL,
                  ...
                  KEY                                       `plugin_fields_subtipofielddropdowns_id`
                                                            (`plugin_fields_subtipofielddropdowns_id`)
