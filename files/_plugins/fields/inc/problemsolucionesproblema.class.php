...
class PluginFieldsProblemsolucionesproblema extends CommonDBTM
{
   ...
   static function install($containers_id = 0) {
      ...
      if (!$DB->tableExists($table)) {
         $query = "CREATE TABLE IF NOT EXISTS `$table` (
                  ...
                  `itemtype`                         VARCHAR(255) DEFAULT 'Problem',
                  `plugin_fields_containers_id`      INT(11)      NOT NULL DEFAULT '9',
                  PRIMARY KEY                        (`id`),
