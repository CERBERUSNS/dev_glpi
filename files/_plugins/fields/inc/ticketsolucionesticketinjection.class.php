...
class PluginFieldsTicketsolucionesticketInjection extends PluginFieldsTicketsolucionesticket implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return Ticket::getTypeName() . " - Soluciones Ticket";
   }
   ...
   **/
   function getOptions($primary_type='') {
      $searchoptions = PluginFieldsContainer::getAddSearchOptions('Ticket', 11);
