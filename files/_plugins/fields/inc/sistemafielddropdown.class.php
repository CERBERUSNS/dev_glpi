...
class PluginFieldsSistemafieldDropdown extends CommonTreeDropdown {
   public $field_name      = "sistemafield";
   ...
   static function install() {
      ...
      if (!$DB->tableExists($table)) {
         $query = "CREATE TABLE IF NOT EXISTS `$table` (
                  ...
                  `plugin_fields_sistemafielddropdowns_id` INT(11)        DEFAULT NULL,
                  ...
                  KEY                                       `plugin_fields_sistemafielddropdowns_id`
                                                            (`plugin_fields_sistemafielddropdowns_id`)
