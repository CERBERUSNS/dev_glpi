...
class PluginFieldsProblemsolucionesproblemaInjection extends PluginFieldsProblemsolucionesproblema implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return Problem::getTypeName() . " - soluciones problemas";
   }
   ...
   **/
   function getOptions($primary_type='') {
      $searchoptions = PluginFieldsContainer::getAddSearchOptions('Problem', 9);
