...
Html::header(__('Reporte99', 'reports'), $_SERVER['PHP_SELF'], "utils", "report");

Report::title();

$report = new PluginReportsAutoReport(__('reporte99_report_title', 'reports'));
...
echo "<tr class='tab_bg_1 center'>".
      "<th colspan='8'>" . __("Reporte General Nro.1", "reports") .
      "</th></tr>\n";
...
$sql = "call Proc_Lista1('2018-01-30','2018-01-31')";
