...
Html::header(__('Reporte2_report_title', 'reports'), $_SERVER['PHP_SELF'], "utils", "report");
...
$sql = "call Proc_Lista2(date(now()),last_day(now()))";
...
*/     
      ...
      echo "<tr class='" . $class . "_top'>".
            ...
            "<td class='center'>".($data["Urgencia"]) . "</td>" .
