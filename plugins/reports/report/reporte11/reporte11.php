...
Html::header(__('Solucionados_sin_cerrar_report_title', 'reports'), $_SERVER['PHP_SELF'], "utils", "report");
...
echo "<tr class='tab_bg_1 center'>".
      "<th colspan='4'>" . __("Tickets Solucionados Sin Cerrar del Mes", "reports") .
      "</th></tr>\n";
...
$sql = "call proc_solu_sin_cerrar_mes(date(now()),last_day(now()))";
