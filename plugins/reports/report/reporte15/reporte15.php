...
Html::header(__('_report_title', 'reports'), $_SERVER['PHP_SELF'], "utils", "report");
...
echo "<tr class='tab_bg_1 center'>".
      "<th colspan='11'>" . __("Reporte General", "reports") .
      "</th></tr>\n";
