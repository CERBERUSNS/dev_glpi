...
Html::header(__('Reporte10_report_title', 'reports'), $_SERVER['PHP_SELF'], "utils", "report");
...
$sql = "call proc_pendientes_priorizados_mes(date(now()),last_day(now()),5)";
