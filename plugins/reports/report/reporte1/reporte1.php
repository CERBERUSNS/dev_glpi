...
Html::header(__('Reporte1_report_title', 'reports'), $_SERVER['PHP_SELF'], "utils", "report");
...
echo "<tr class='tab_bg_1 center'>".
      "<th colspan='8'>" . __("Reporte de Tickets General_1", "reports") .
      "</th></tr>\n";
...
$sql = "call Proc_Lista1(date(now()),last_day(now()))";
