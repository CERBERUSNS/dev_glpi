...
Html::header(__('Reporte9_report_title', 'reports'), $_SERVER['PHP_SELF'], "utils", "report");
...
$sql = "call proc_solucionados_por_prioridad_mes(date(now()),last_day(now()), 5)";
