...
Html::header(__('Solucionados_y_cerrados_antes_diez_dias_report_title', 'reports'), $_SERVER['PHP_SELF'], "utils", "report");
...
echo "<tr class='tab_bg_1 center'>".
      "<th colspan='4'>" . __("Tickets Solucionados y Cerrados Antes de Diez Dias", "reports") .
      "</th></tr>\n";

echo "<tr class='tab_bg_2'><th>". __('Categoria', 'reports') . "</th>" .
      "<th>". __('Total','reports') . "</th>"
      //"<th>". __("Computer's name") . "</th>".
      //"<th>". sprintf(__('%1$s (%2$s)'), _n('Software', 'Software', 1), __('version'))."</th></tr>\n
      ;

$sql = "call proc_solu_cerra_antes_diez_dias(date(now()),last_day(now()))";
